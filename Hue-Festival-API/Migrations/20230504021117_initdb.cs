    ...
    public partial class initdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_locationWishlists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_locationWishlists_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_locationWishlists_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketTypes_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckIns_Employee_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_locationWishlists_LocationId",
                table: "locationWishlists",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_locationWishlists_UserId",
                table: "locationWishlists",
                column: "UserId");
